...
export default class PreviewSectionInfo extends Component {
                    ...
                    <ScrollView style={{ flexGrow: 1 }}>
                        ...
                        <View style={styles.container}>
                            {Object.keys(this.props.parts).map((item, key) =>
                                <PageList key={key} lang={lang} title={this.props.parts[item].title[lang]} id={this.props.parts[item].id} page_title={this.props.page_title} from_page={this.props.from_page} section_title={this.props.title} pages={this.props.parts[this.props.parts[item].id].page} item={item} />
                            )}
                        </View>
                    </ScrollView>
                    <ContinueInfo />
